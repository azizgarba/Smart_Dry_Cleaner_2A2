...
int excel::export2Excel()
{
   ...
   /* //DRIVER={Microsoft Excel Driver (*.xls)};DSN='';FIRSTROWHASNAMES=1;READONLY=FALSE;CREATE_DB=\"%1\";DBQ=%2
    //DRIVER={Microsoft Excel Driver (*.xls)}; READONLY=FALSE; FIL={MS Excel}; DBQ=C:/Desktop/test.xls
    if(fieldList.size() <= 0)
    {
